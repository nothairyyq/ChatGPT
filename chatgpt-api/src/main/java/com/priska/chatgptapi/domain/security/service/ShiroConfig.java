...
import com.priska.chatgptapi.domain.security.service.realm.JwtRealm;
...
public class ShiroConfig {
    ...
    public SubjectFactory subjectFactory(){
        class JwtDefaultSubjectFactory extends DefaultWebSubjectFactory{
            ...
            public Subject createSubject(SubjectContext context){
                context.setSessionCreationEnabled(false); //禁用session创建
    ...
    public DefaultWebSecurityManager securityManager() {
        //创建并返回一个DefaultWebSecurityManager实例，负责管理与所有安全相关的操作：登录验证，权限校验，会话管理
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        //shiro集成到web环境的组件，负责拦截请求和执行安全检查
